...
def main(cfg: RLConfig):
    ...
    from utils.rl_core import collate_trajectories,collect_rollouts,apply_hybrid_splitting
    ...
    try:
        ...
        for global_cycle in range(num_rollouts):
            ...
            apply_hybrid_splitting(traj_batch)
            ...
            while pending_futures:
                ...
                for ref in ready_refs:
                    ...
                    try:
                        ...
                        valid_mask = (batch_row['response_mask'] | batch_row['dagger_mask']).bool()
                        ...
                        rollout_stats = {
                            ...
                            "rollout/n_rl": int(traj_stats['response_mask'].sum().item()),
                            "rollout/n_bc": int(traj_stats['dagger_mask'].sum().item())
                        }
